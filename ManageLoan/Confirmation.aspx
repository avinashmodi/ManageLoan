<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Confirmation.aspx.cs" Inherits="ManageLoan.Confirmation" %>
...
<body>
    ...
    <fieldset disabled>
        <div class="container" style="max-width: 800px; margin-left: 60px">
            ...
            <div class="form-group row input-group mb-3">
                ...
                <%--<div class="col-sm-10">--%>
                    <input type="text" class="form-control" style="margin-left: 20px" id="ClientName" placeholder="">
                <%--</div>--%>
    ...
    <div class="container" style="max-width: 800px; margin-left: 650px">
        <div class="form-group row">
            <div class="col-sm-10">
