<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="ManageLoan.Dashboard" %>
...
<body>
   ...
   <div class="container-fluid" style="background-color:#7ec3f1" >
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="nav nav-pills mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="InitiateLoan.aspx">Initiate Loan</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Link</a>
                </li>
    ...
    <div class="container" runat="server" id="divTable" style="max-width: 1200px; margin-left: 60px">
        <!-- Content here -->
